...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('quinode_shipping_shipping', (
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['product.Product'], unique=True, primary_key=True)),
            ('is_bulky', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('quinode_shipping', ['Shipping'])


    def backwards(self, orm):
        
        # Deleting model 'Shipping'
        db.delete_table('quinode_shipping_shipping')
    ...
    models = {
        ...
        'quinode_shipping.shipping': {
            'Meta': {'object_name': 'Shipping'},
            'is_bulky': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
